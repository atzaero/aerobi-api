 ...
 * JSON com o array de itens (ver BatchMovementItemDTO); os arquivos vão no campo
 ...
 */
export class BatchMovementResultItemDTO {
...
export class CreateMovementBatchResponseDTO {
  ...
  @ApiProperty({ type: [BatchMovementResultItemDTO] })
  items!: BatchMovementResultItemDTO[];
}
