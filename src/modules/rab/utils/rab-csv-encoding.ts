/** Extrai e normaliza o encoding do CSV RAB (header HTTP + heurísticas no buffer). */
...
/**
 * Escolhe o label passado a `TextDecoder` para o buffer do CSV.
 * Ordem: charset no Content-Type → BOM UTF-8 → UTF-8 válido (fatal) → windows-1252.
 */
export function resolveRabCsvTextDecoderLabel(
  buffer: Buffer,
