...
import { ExportFeedbacksService } from './export-feedbacks.service';
...
describe('ExportFeedbacksService', () => {
  let service: ExportFeedbacksService;
  ...
  beforeEach(() => {
    ...
    service = new ExportFeedbacksService(
      repo,
      userRepo,
  ...
  it('trunca em EXPORT_MAX_ROWS e sinaliza truncated + total real', async () => {
    ...
    const one = buildFeedbackFixture();
