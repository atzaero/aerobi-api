...
import type { ExportFeedbacksService } from '../services/export-feedbacks.service';

import { ExportFeedbacksController } from './export-feedbacks.controller';

describe('ExportFeedbacksController', () => {
  let controller: ExportFeedbacksController;
  ...
  beforeEach(() => {
    ...
    controller = new ExportFeedbacksController({
      execute,
    } as unknown as ExportFeedbacksService);
  });
