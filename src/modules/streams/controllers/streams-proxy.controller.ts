 ...
 * BFF intermediário.
 *
 * - `GET /streams/:cameraId/index.m3u8` — master playlist
 * - `GET /streams/:cameraId/:segment` — segmentos (`*.m4s`, `*.mp4`, `init.mp4`)
 *   e playlists de variante (`*.m3u8`, ex.: `video1_stream.m3u8`) que o master
 *   referencia num stream multivariante (default do mediamtx em fMP4/LL-HLS)
 *
