 ...
 * alfanuméricos), no mesmo formato de `Movement.aerodrome`. A maioria dos
 * aeródromos pequenos usa códigos com dígitos (ex.: `SJ4E`, `SI63`). Aceita
 * minúsculas; o service normaliza.
 */
