...
export function CreateAircraftReadingBatchDocs() {
  return applyDecorators(
    ...
    ApiBody({
      schema: {
        ...
        properties: {
          metadata: {
            type: 'string',
            description: 'JSON array de itens (ver BatchReadingItemDTO).',
            example:
    ...
    ApiCreatedResponse({ type: CreateAircraftReadingBatchResponseDTO }),
  );
}
