...
- `aerodrome-geojson.repository.interface.ts` — assinatura `IAerodromeGeojsonRepository`.
- `aerodrome-geojson.repository.ts` — implementação `AerodromeGeojsonRepository implements IAerodromeGeojsonRepository`.
...
- Registrar o repository como provider no `aerodrome-geojsons.module.ts`.
