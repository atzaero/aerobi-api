...
export function ListVisibleAerodromesDocs() {
  return applyDecorators(
    ...
    ApiOperation({
      ...
      description:
        'Consulta pública autenticada com `X-API-Key`. Retorna **todos** os aeródromos ativos com `isView=true` (array completo, sem paginação) para popular o mapa. Sem JWT/RBAC.',
    }),
    ApiOkResponse({
