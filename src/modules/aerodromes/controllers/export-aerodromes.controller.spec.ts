...
import type { ExportAerodromesService } from '../services/export-aerodromes.service';

import { ExportAerodromesController } from './export-aerodromes.controller';

describe('ExportAerodromesController', () => {
  let controller: ExportAerodromesController;
  ...
  beforeEach(() => {
    ...
    controller = new ExportAerodromesController({
      execute,
    } as unknown as ExportAerodromesService);
  });
