...
- `aerodrome.repository.interface.ts` — assinatura `IAerodromeRepository`.
- `aerodrome.repository.ts` — implementação `AerodromeRepository implements IAerodromeRepository`.
...
- Registrar o repository como provider no `aerodromes.module.ts`.
