...
export function ResendInviteDocs() {
  return applyDecorators(
    ...
    ApiBearerAuth(),
    ApiOperation({
      summary: 'Reenvia convite para um usuário que ainda não aceitou (ADMIN)',
      description:
        'Invalida convites pendentes do usuário e emite um novo Token ' +
        'tipo INVITE, disparando email novamente. Falha com ' +
    ...
    ApiForbiddenResponse({ description: 'Apenas ADMIN pode reenviar.' }),
  );
}
