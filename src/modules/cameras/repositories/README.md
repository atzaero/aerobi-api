...
- `camera.repository.interface.ts` — assinatura `ICameraRepository`.
- `camera.repository.ts` — implementação `CameraRepository implements ICameraRepository`.
...
- Registrar o repository como provider no `cameras.module.ts`.
